...
public class BackgroundPanel extends JPanel
{
    ...
    /*
     *  Override method so we can make the co7mponent transparent
     */
    ...
    public static void main(String[] args)
    {
        ...
        BackgroundPanel mainPanel = new BackgroundPanel(new ImageIcon("C:\\Users\\Rosenberg\\Pictures\\Saved Pictures\\726297.png").getImage());
        frame.setContentPane(mainPanel);
        frame.pack();
        var btn0 = new JButton("123");
        btn0.setPreferredSize(new Dimension(100, 50));
        JPanel panel = new JPanel();
        //panel.setOpaque(false);
        mainPanel.add(panel, BorderLayout.CENTER);
        //???????????????????????????????? Panel hava color fuck it go damn to the the hell!!!!!
        panel.add(btn0, BorderLayout.SOUTH);
